...
public class Connect4FieldModel implements Connect4FieldInterface {
	...
	public PlayerInterface playerArrayInterface2[] = new PlayerInterface[2];
	
	public PlayerInterface playerArrayInterface4[] = new PlayerInterface[4];
	...
	public Connect4FieldModel()
	{
		...
		//this.playerArrayInterface[] = new Player();
	}
